...
- the `${BEAMPIPE_VERSION:-0.1.2}` default in [`docker-compose.yml`](https://github.com/jbwod/beampipe-core-v2/blob/main/docker-compose.yml), [`deploy/operator/docker-compose.yml`](https://github.com/jbwod/beampipe-core-v2/blob/main/deploy/operator/docker-compose.yml), and the header comment in [`deploy/setup-docker.sh`](https://github.com/jbwod/beampipe-core-v2/blob/main/deploy/setup-docker.sh)
...
- `SHA256SUMS`
- `install.sh`
- `ghcr.io/jbwod/beampipe-core-v2:0.1.2` (also `:0.1` and `:latest`; `linux/amd64` and `linux/arm64`)

```bash
git tag -a v0.1.2 -m "Beampipe 0.1.2"
