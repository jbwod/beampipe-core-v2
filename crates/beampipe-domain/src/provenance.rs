...
pub enum ProvenanceEventType {
    ...
    ExecutionCreated,
    ExecutionRunning,
    ExecutionAwaitingScheduler,
    ExecutionExecuteStarted,
    ExecutionCompleted,
    ExecutionFailed,
    ExecutionCancelled,
...
impl ProvenanceEventType {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ExecutionRunning => "execution.running",
            Self::ExecutionAwaitingScheduler => "execution.awaiting_scheduler",
            Self::ExecutionExecuteStarted => "execution.execute_started",
